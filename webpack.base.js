...
const createFiles = () => {
    ...
    for (file of files) {
        ...
        let chunks = process.env.NODE_ENV == 'development' ? [name] : [name, 'verndor', 'commons'];
        let tplName = process.env.NODE_ENV == 'development' ? 'index' : 'index';
        result.push(
...
const createPage = () => {
    ...
    let chunks = process.env.NODE_ENV == 'development' ? [config.page] : [config.page, 'verndor', 'commons'];
...
let HtmlPlugins = config.mutify ? createFiles().htmlPlugins : [createPage().page];
let mainEntries = config.mutify ? createFiles().mainEntries : createPage().mainEntries;
